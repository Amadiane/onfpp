...
SECRET_KEY = 'django-insecure-=vzk5kihpjq$+83ivg-bqelulmewy!_cqvda%z^zm63ht1j#v-'
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": [
        "rest_framework.permissions.IsAuthenticated",  # protège tout par défaut
    ],
}
